...
| "...for today" / "add X to today" / any named day | quick-create-action with \`scheduledStart\` set to that day (ISO, from today's date) — without it the action won't show on /today |

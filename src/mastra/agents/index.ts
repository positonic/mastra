...
// Export Local wiki librarian (device-local markdown wiki; tools arrive from the
// Tauri shell as clientTools, so this agent deliberately declares none)
export { localWikiAgent } from './local-wiki-agent.js';
